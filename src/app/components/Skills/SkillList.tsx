  ...
  return (
    <div className="flex flex-col max-w-full ml-5">
      ...
      {filteredSkills.map((skill, index) => (
        <div
          key={index}
          className="flex hover:-translate-y-1 transition-transform duration-300 ease-in-out bg-slate-200 dark:bg-dark-background w-full text-wrap rounded-xl mr-20 p-1 mb-5"
        >
          <Image
            src={skill.icon}
